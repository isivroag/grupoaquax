...
DROP DATABASE IF EXISTS `gstone`;
...
-- Volcando estructura para tabla gstone.detalle_pres
DROP TABLE IF EXISTS `detalle_pres`;
CREATE TABLE IF NOT EXISTS `detalle_pres` (
...
-- Volcando datos para la tabla gstone.detalle_pres: ~18 rows (aproximadamente)
DELETE FROM `detalle_pres`;
/*!40000 ALTER TABLE `detalle_pres` DISABLE KEYS */;
INSERT INTO `detalle_pres` (`id_reg`, `folio_pres`, `id_concepto`, `id_item`, `id_precio`, `precio`, `cantidad`, `total`) VALUES
	(2, 1, 3, 1, 5, 220.00, 150.00, 33000.00),
	(3, 2, 3, 1, 5, 220.00, 21.00, 4620.00),
	(4, 2, 3, 1, 5, 220.00, 2.00, 440.00),
	(5, 2, 3, 1, 5, 220.00, 3.00, 660.00),
	(6, 3, 3, 1, 5, 220.00, 21.00, 4620.00),
	(9, 4, 3, 1, 5, 220.00, 21.00, 4620.00),
	(10, 4, 3, 1, 5, 220.00, 3.00, 660.00),
	(12, 5, 15, 8, 10, 150.00, 250.00, 37500.00),
	(13, 6, 15, 10, 9, 200.00, 153.00, 30600.00),
	(14, 7, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(15, 7, 6, 2, 2, 3522.00, 7.35, 25886.70),
	(16, 8, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(17, 9, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(18, 10, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(19, 10, 4, 5, 13, 5500.00, 25.00, 137500.00),
	(20, 11, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(21, 11, 4, 5, 13, 5500.00, 25.00, 137500.00),
	(22, 12, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(23, 12, 4, 5, 13, 5500.00, 25.00, 137500.00),
	(24, 13, 6, 2, 2, 3522.00, 2.69, 9474.18),
	(25, 13, 15, 8, 11, 200.00, 2.69, 538.00);
/*!40000 ALTER TABLE `detalle_pres` ENABLE KEYS */;

-- Volcando estructura para tabla gstone.detalle_tmp
DROP TABLE IF EXISTS `detalle_tmp`;
...
-- Volcando datos para la tabla gstone.detalle_tmp: ~5 rows (aproximadamente)
...
INSERT INTO `detalle_tmp` (`id_reg`, `folio_pres`, `id_concepto`, `id_item`, `id_precio`, `precio`, `cantidad`, `total`) VALUES
	...
	(8, 2, 6, 1, 4, 2000.00, 3.90, 7800.00),
	(9, 2, 4, 5, 13, 5500.00, 25.00, 137500.00),
	(10, 4, 6, 2, 2, 3522.00, 2.69, 9474.18),
	(11, 4, 15, 8, 11, 200.00, 2.69, 538.00);
...
CREATE TABLE IF NOT EXISTS `presupuesto` (
  ...
  `concepto_pres` varchar(500) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `ubicacion` varchar(500) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
-- Volcando datos para la tabla gstone.presupuesto: ~11 rows (aproximadamente)
DELETE FROM `presupuesto`;
/*!40000 ALTER TABLE `presupuesto` DISABLE KEYS */;
INSERT INTO `presupuesto` (`folio_pres`, `id_pros`, `fecha_pres`, `concepto_pres`, `ubicacion`, `total`, `estado_pres`, `tokenid`) VALUES
	(1, 1, '2020-09-20', 'Instalación de cubierta de cocina', 'Montemagno 512', 33000.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(2, 4, '2020-09-20', 'presupuesto 2', 'Ubicacion', 5720.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(3, 1, '2020-09-18', 'presupuesto real numero 3', 'Casa Habitación', 4620.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(4, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 5280.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(5, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 37500.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(6, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 30600.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(7, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 33686.70, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(8, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 7800.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(9, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 7800.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(10, 1, '2020-09-18', 'presupuesto 3', 'Casa Habitación', 145300.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(11, 1, '2020-09-18', 'Ultimo presupuesto temporal 2', 'Casa Habitación', 145300.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(12, 1, '2020-09-18', 'Ultimo presupuesto temporal 2', 'Casa Habitación', 145300.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(13, 5, '2020-09-21', '0', '0', 10012.18, 1, 'fe01ce2a7fbac8fafaed7c982a04e229');
...
INSERT INTO `prospecto` (`id_pros`, `nombre`, `correo`, `calle`, `num`, `col`, `cp`, `cd`, `edo`, `tel`, `cel`, `status`) VALUES
	...
	(5, 'odette', 'isivroag@hotmail.com', 'obispo', '8', 'infonavit loma alta', 91170, 'Xalapa', 'Veracruz', '255552', '5655', b'1');
...
DROP TABLE IF EXISTS `subtipo_concepto`;
...
-- Volcando datos para la tabla gstone.tmp_pres: ~3 rows (aproximadamente)
...
INSERT INTO `tmp_pres` (`folio_pres`, `id_pros`, `fecha_pres`, `concepto_pres`, `ubicacion`, `total`, `estado_pres`, `tokenid`) VALUES
	...
	(2, 1, '2020-09-18', 'Ultimo presupuesto temporal 2', 'Casa Habitación', 145300.00, 2, '21232f297a57a5a743894a0e4a801fc3'),
	(3, 0, '2020-09-21', '0', '0', 0.00, 1, '21232f297a57a5a743894a0e4a801fc3'),
	(4, 5, '2020-09-21', '0', '0', 10012.18, 2, 'fe01ce2a7fbac8fafaed7c982a04e229');
...
DROP VIEW IF EXISTS `vconceptos`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
-- Volcando estructura para vista gstone.vdetalle_pres
DROP VIEW IF EXISTS `vdetalle_pres`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `vdetalle_pres` (
...
DROP VIEW IF EXISTS `vdetalle_tmp`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
-- Volcando estructura para vista gstone.vpres
DROP VIEW IF EXISTS `vpres`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `vpres` (
...
DROP VIEW IF EXISTS `vpresupuesto`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP VIEW IF EXISTS `vsubtipo_concepto`;
-- Creando tabla temporal para superar errores de dependencia de VIEW
...
DROP TABLE IF EXISTS `w_usuario`;
...
INSERT INTO `w_usuario` (`id_usuario`, `username`, `nombre`, `email`, `password`, `edo_usuario`, `rol_usuario`) VALUES
	...
	(2, 'demo', 'Romero', 'isivroag@gmail.com', '202cb962ac59075b964b07152d234b70', b'1', 1),
...
DROP VIEW IF EXISTS `vdetalle_pres`;
-- Eliminando tabla temporal y crear estructura final de VIEW
DROP TABLE IF EXISTS `vdetalle_pres`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vdetalle_pres` AS select `detalle_pres`.`id_reg` AS `id_reg`,`detalle_pres`.`folio_pres` AS `folio_pres`,`detalle_pres`.`id_concepto` AS `id_concepto`,`concepto`.`nom_concepto` AS `nom_concepto`,`detalle_pres`.`id_item` AS `id_item`,`item`.`clave_item` AS `clave_item`,`item`.`nom_item` AS `nom_item`,`detalle_pres`.`id_precio` AS `id_precio`,`precio`.`formato` AS `formato`,`precio`.`id_umedida` AS `id_umedida`,`umedida`.`nom_umedida` AS `nom_umedida`,`precio`.`monto` AS `monto`,`detalle_pres`.`precio` AS `precio`,`detalle_pres`.`cantidad` AS `cantidad`,`detalle_pres`.`total` AS `total` from ((((`detalle_pres` join `concepto` on((`detalle_pres`.`id_concepto` = `concepto`.`id_concepto`))) join `item` on((`detalle_pres`.`id_item` = `item`.`id_item`))) join `precio` on((`detalle_pres`.`id_precio` = `precio`.`id_precio`))) join `umedida` on((`concepto`.`id_umedida` = `umedida`.`id_umedida`))) order by `detalle_pres`.`id_reg` ;
...
DROP VIEW IF EXISTS `vpres`;
-- Eliminando tabla temporal y crear estructura final de VIEW
DROP TABLE IF EXISTS `vpres`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vpres` AS select `presupuesto`.`folio_pres` AS `folio_pres`,`presupuesto`.`id_pros` AS `id_pros`,`prospecto`.`nombre` AS `nombre`,`presupuesto`.`fecha_pres` AS `fecha_pres`,`presupuesto`.`concepto_pres` AS `concepto_pres`,`presupuesto`.`ubicacion` AS `ubicacion`,`presupuesto`.`total` AS `total`,`presupuesto`.`estado_pres` AS `estado_pres`,`presupuesto`.`tokenid` AS `tokenid` from (`presupuesto` left join `prospecto` on((`presupuesto`.`id_pros` = `prospecto`.`id_pros`))) ;
