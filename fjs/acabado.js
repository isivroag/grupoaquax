$(document).ready(function() {
    ...
    $("#btnNuevo").click(function() {
        ...
        $(".modal-title").text("Nuevo Acabado");
    ...
    $("#formDatos").submit(function(e) {
        ...
        if (nombre.length == 0 || clave.length == 0) {
            ...
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                data: { nombre: nombre, clave: clave, id: id, opcion: opcion },
                success: function(data) {
                    console.log(data);
                    console.log(fila);

                    //tablaPersonas.ajax.reload(null, false);
                    id = data[0].id_acabado;
                    clave = data[0].clave_acabado;
                    nombre = data[0].nom_acabado;
