    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-orange text-light">
                <h1 class="card-title mx-auto">Subtipo de Concepto</h1>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $dat['nom_t_concepto'] ?></td>
                                                <td><?php echo $dat['id_subt_concepto'] ?></td>
                                                <td><?php echo $dat['nom_subt_concepto'] ?></td>
                                                <td></td>
                                            </tr>
                                        <?php
                                        }
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary">
                        <h5 class="modal-title" id="exampleModalLabel">NUEVO TIPO DE CONCEPTO</h5>
                        ...
                        <form id="formDatos" action="" method="POST">
                            <div class="modal-body row">
                                ...
                                <div class="form-group input-group-sm auto">
                                    ...
                                    <select class="form-control" name="tipo" id="tipo" autocomplete="off" placeholder="Tipo">
                                        <?php
...
<script src="fjs/subtipo.js"></script>
