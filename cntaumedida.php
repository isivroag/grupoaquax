...
$consulta = "SELECT * FROM umedida order by id_umedida";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-orange text-light">
                <h1 class="card-title mx-auto">Tipo de Concepto</h1>
            </div>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary">
                        <h5 class="modal-title" id="exampleModalLabel">NUEVA UNIDA DE MEDIDA</h5>
                            ...
                            <div class="modal-body row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group input-group-sm">
                                        <label for="nombre" class="col-form-label">Unidad de Medida:</label>
...
<script src="fjs/umedida.js"></script>
