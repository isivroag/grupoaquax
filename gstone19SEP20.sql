...
INSERT INTO `concepto` (`id_concepto`, `nom_concepto`, `id_umedida`, `id_t_concepto`, `id_subt_concepto`, `estado_concepto`, `uso_mat`) VALUES
	...
	(6, 'CUBIERTA DE BAÑO', 1, 1, 2, b'1', NULL),
	(7, 'OVALIN', 1, 1, 2, b'1', NULL),
	(8, 'CUBIERTA DE BAÑO DE PEDESTAL', 1, 1, 2, b'1', NULL),
	(9, 'ESCALERAS', 1, 1, 3, b'1', NULL),
	(10, 'MAQUILA COCINA', 2, 1, 4, b'1', NULL),
	(11, 'MAQUILA BAÑO', 1, 1, 4, b'1', NULL),
	(12, 'MAQUILA ISLA', 1, 1, 4, b'1', NULL),
	(13, 'MAQUILA BARRA DE BAR', 1, 1, 4, b'1', 'Si'),
	(15, 'COLOCACION', 1, 2, 0, b'1', 'NO'),
	(16, 'SUMINISTRO', 1, 2, 0, b'1', NULL),
	(17, 'DETALLES', 3, 3, 0, b'1', 'NO'),
	(18, 'MANTENIMIENTO', 1, 3, 0, b'1', NULL);
...
-- Volcando datos para la tabla gstone.precio: ~6 rows (aproximadamente)
DELETE FROM `precio`;
...
-- Volcando estructura para tabla gstone.tmp_detpres
DROP TABLE IF EXISTS `tmp_detpres`;
CREATE TABLE IF NOT EXISTS `tmp_detpres` (
  `id_reg` bigint(20) NOT NULL AUTO_INCREMENT,
  `folio_pres` bigint(20) DEFAULT NULL,
  `id_concepto` bigint(20) DEFAULT NULL,
  `tipo_item` bigint(20) DEFAULT NULL,
  `id_ref` bigint(20) DEFAULT NULL,
  `id_umedida` bigint(20) DEFAULT NULL,
...
-- Volcando datos para la tabla gstone.tmp_detpres: ~0 rows (aproximadamente)
DELETE FROM `tmp_detpres`;
/*!40000 ALTER TABLE `tmp_detpres` DISABLE KEYS */;
/*!40000 ALTER TABLE `tmp_detpres` ENABLE KEYS */;
...
-- Volcando datos para la tabla gstone.tmp_pres: ~0 rows (aproximadamente)
...
INSERT INTO `tmp_pres` (`folio_pres`, `id_pros`, `fecha_pres`, `concepto_pres`, `ubicacion`, `total`, `estado_pres`, `tokenid`) VALUES
	(1, 4, '2020-09-18', '0', '0', 0.00, 1, '21232f297a57a5a743894a0e4a801fc3');
