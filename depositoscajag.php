...
if ($folio != "") {
    ...
    $opcion = 2;
    $consulta = "SELECT * FROM w_depositosg where folio_depositog='$folio'";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-blue text-light">
                <h1 class="card-title mx-auto">Retiro a Bancos</h1>
            </div>
                    ...
                    <div class="content" >
                        ...
                        <div class="card card-widget" style="margin-bottom:0px;">
                            ...
                            <div class="card-header bg-gradient-blue " style="margin:0px;padding:8px">
                                ...
                                <h1 class="card-title ">Registro de Retiro a Bancos</h1>
                            </div>
...
<script src="fjs/depositoscajag.js"></script>
