...
$consulta = "SELECT * FROM acabado order by id_acabado";
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header bg-gradient-orange text-light">
                <h1 class="card-title mx-auto">Acabados</h1>
            </div>
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    <div class="modal-header bg-gradient-primary">
                        <h5 class="modal-title" id="exampleModalLabel">NUEVO ACABADO</h5>
...
<script src="fjs/acabado.js"></script>
